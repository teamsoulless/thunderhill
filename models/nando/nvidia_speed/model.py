...
from loader import generate_thunderhill_batches, getDataFromFolder, getDataFromThunderhill
from config import *
...
if __name__ == '__main__':
    ...
    df_train, df_val = getDataFromThunderhill(args.dataset, args.output, balance=False)
