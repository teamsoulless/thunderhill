...
def main():
    ...
    if LOADMODEL:
        endModel = load_model('psyncModelGPS.h5', custom_objects={'customLoss':customLoss})
        ...
        xOut = Lambda(lambda x : K.concatenate(x, axis=1))([xOut, speedInp, gpsInp])
        xOut = Dense(200)(xOut)
        ...
        xOutThr = Dense(50, name='thr3')(xOutThr)
