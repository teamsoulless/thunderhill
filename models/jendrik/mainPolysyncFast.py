...
def customLoss(y_true, y_pred):
    ...
    """
    return 10*K.mean(K.square(y_pred - y_true), axis=-1) #+.01* K.mean(K.square(y_pred), axis = -1)
...
def main():
    ...
    """
    data3 = pd.read_csv('/home/jjordening/git/thunderhill-racing/testing/RecorderNode/1550/output_processed.txt')
    data3['path'] = '/home/jjordening/git/thunderhill-racing/testing/RecorderNode/1550/'+data3['path'].apply(lambda x: x.strip())
    
    data4 = pd.read_csv('/home/jjordening/git/thunderhill-racing/testing/RecorderNode/1605/output_processed.txt')
    data4['path'] = '/home/jjordening/git/thunderhill-racing/testing/RecorderNode/1605/'+data4['path'].apply(lambda x: x.strip())
    
    data5 = pd.read_csv('/home/jjordening/git/thunderhill-racing/testing/RecorderNode/1654/output_processed.txt')
    data5['path'] = '/home/jjordening/git/thunderhill-racing/testing/RecorderNode/1654/'+data5['path'].apply(lambda x: x.strip())
    
    data6 = pd.read_csv('/home/jjordening/git/thunderhill-racing/testing/RecorderNode/1711/output_processed.txt')
    data6['path'] = '/home/jjordening/git/thunderhill-racing/testing/RecorderNode/1711/'+data6['path'].apply(lambda x: x.strip())
    
    data7 = pd.read_csv('/home/jjordening/data/823/output_processed.txt')
    data7['path'] = '/home/jjordening/data/1610/'+data7['path'].apply(lambda x: x.strip())
    
    data8 = pd.read_csv('/home/jjordening/data/832/output_processed.txt')
    data8['path'] = '/home/jjordening/data/1645/'+data8['path'].apply(lambda x: x.strip())
    
    data9 = pd.read_csv('/home/jjordening/data/837/output_processed.txt')
    data9['path'] = '/home/jjordening/data/1702/'+data9['path'].apply(lambda x: x.strip())
    ...
    if LOADMODEL:
        endModel = load_model('psyncModelFast.h5', custom_objects={'customLoss':customLoss})
